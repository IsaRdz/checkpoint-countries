const countries = [
  ...
  },
  {
    ...
    coatOfArms: {png: "./assets/Escudo_vacío.png"},
    startOfWeek: "monday",
...
function cardWithCountries(countries){
    ...
    for(let i = 0; i<countries.length; i++){
        ...
        <div class="card">
            <div class="card-information">
                <div>
                    <img src= ${countries[i].flags.svg} alt="-icono-bandera">
                    <p class="name-country"><span> Country name: </span>${countries[i].name.common} </p>                
                </div>
                <div>
                    <img src="./assets/time-zone.png" alt="icon-time-zone">
                    <p class="time-zone"><span>Time-zone: </span>${countries[i].timezones} </p>
                </div>
                <div>
                    <img src="./assets/map.png" alt="icon-maps">
                    <p class="p-location">Location: <a href=${countries[i].maps.googleMaps} target= "_blank">${countries[i].maps.googleMaps} </a></p>
                </div>            
            </div>
    
            <div class="card-image">
                <img src= ${countries[i].coatOfArms.png} alt="">
            </div>
        </div>
        `;
    }
